...
{
    UIImageView *imageView = [[UIImageView alloc] initWithImage:HTImageNamed(@"hudSuccess")];
...
{
    UIImageView *imageView = [[UIImageView alloc] initWithImage:HTImageNamed(@"hudError")];
    imageView.frame = CGRectMake(0, 0, 32, 32);
